...
/*
     ...
     INTERNET ARCHIVE ON 1:10:00 Jul 14, 2014.
	...
	var PAPromoLoader = {
		populatePromos: function(data) {
			if (data.length > 0) {
				...
				var url = "/web/20111228013055/http://pa-promos.appspot.com/forward?promo="+promoData['key']+"&url="+promoData['link_url']+"&cb="+cachebuster;
