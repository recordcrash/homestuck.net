...
/*
     FILE ARCHIVED ON 8:19:24 Jan 13, 2012 AND RETRIEVED FROM THE
 ...
 *
 * Thanks to /web/20120113081924/http://technology.hostei.com/?p=3
 */
 ...
 * (barrakketh@gmail.com) from /web/20120113081924/http://forums.penny-arcade.com to allow
 * parameters.
 *
 * Thanks!
 */
   ...
   ButtonBar = {
      ...
      PrepareBBCode: function(ButtonBarObj, TextArea) {
         $("<div></div>")
            ...
            .html('You can use <b><a href="/web/20120113081924/http://en.wikipedia.org/wiki/BBCode">BBCode</a></b> in your post.')
      ...
      PrepareHtml: function(ButtonBarObj, TextArea) {
         ...
         $("<div></div>")
            .addClass('ButtonBarMarkupHint')
            .html('You can use <b><a href="/web/20120113081924/http://htmlguide.drgrog.com/cheatsheet.php">Simple Html</a></b> in your post.')
            .insertAfter(TextArea);
      },
      ...
      PrepareMarkdown: function(ButtonBarObj, TextArea) {
         ...
         $("<div></div>")
            .addClass('ButtonBarMarkupHint')
            .html('You can use <b><a href="/web/20120113081924/http://en.wikipedia.org/wiki/Markdown">Markdown</a></b> in your post.')
            .insertAfter(TextArea);
      },
